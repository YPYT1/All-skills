...
- **Primary:** MOLT3D Telegram group (-1003892992445) — Background monitor (`molt3d-monitor` session) running continuously, polling every 30s for Snail's messages and ClawdSense activity (🔴 Sentry, 📸 Button). Bot token: <TELEGRAM_BOT_TOKEN_REDACTED>. Live as of Jan 28, 02:55.
